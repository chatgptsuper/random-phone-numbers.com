...
export const metadata: Metadata = {
  title:
    "Japanese Phone Number Generator - Generate Random Japan Phone Numbers",
  description:
    "Japanese Phone Number Generator. Create mobile numbers with valid carrier prefixes and proper formats for Japan.",
};
      ...
      <section className="py-12 bg-base-200">
        <div className="container mx-auto px-4">
          ...
          <p className="text-xl text-center text-base-content/80 max-w-2xl mx-auto">
            Generate random Japanese phone numbers with proper carrier prefixes
            and formats.
          </p>
        </div>
      </section>
          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className="bg-base-200 p-8 rounded-xl shadow-lg">
              ...
              <ul className="list-disc pl-6 space-y-2 text-base-content/80">
                ...
                <li>
                  Total length should be 11 digits (excluding country code)
                </li>
